...
describe('helper.js', () => {
  describe('fetchCall', () => {
    ...
    beforeEach(() => {
      mockmovieObject = { results: [
        { 
          ...
          opening: 'Space: the final frontier.',
        ...
        { 
          ...
          somethingElse: 'info that will be taken out of this object'
        }
      ] };
      ...
      window.fetch = jest.fn().mockImplementation(() => Promise.resolve({ 
        ok: true, json: () => Promise.resolve(mockmovieObject)
      }));
    ...
    it('should throw an error if status is not okay', async () => {
      ...
      window.fetch = jest.fn().mockImplementation(() => Promise.resolve({
        ok: false, json: () => Promise.resolve(mockmovieObject)
      }));
    ...
    it('should throw an error if fetch fails', async () => {
      ...
      window.fetch = jest.fn().mockImplementation(() => (
        Promise.reject(Error('API call failed'))
      ));
      //execution && expectation
      await expect(fetchCall(mockURL)).rejects.toEqual(expected);
    });
  ...
  describe('getItemList', () => {
    ...
    beforeEach( ()=> {
      ...
      mockmovieObject = { results: [
        { 
          Name: 'three',
          Model: 'march',
          Class: 'three is a magic number',
          NumPassengers: 100,
          somethingElse: 'remove this'
        },
        { 
          Name: 'four',
          Model: 'april',
          Class: 'four is a magic number',
          NumPassengers: 101,
          somethingElse: 'remove this'
        },
        { 
    ...
    it('returns an itemList cleaned according the the parameters', async () => {
    ...
    beforeEach(() => {
      ...
      mockmovieObject = { results: [
        ...
        { 
          title: 'three',
          date: 'march',
          opening: 'three is a magic number',
          somethingElse: 'remove this'
        },
        { 
          title: 'four',
          date: 'april',
          opening: 'four is a magic number',
          somethingElse: 'remove this'
        },
        { 
          title: 'five',
          date: 'may',
          opening: 'five is a magic number',
          somethingElse: 'remove this'
        },
        { 
          title: 'six',
          date: 'june',
          opening: 'six is a magic number',
          somethingElse: 'remove this'
        },
        { 
          title: 'seven',
          date: 'july',
          opening: 'seven is a magic number',
          somethingElse: 'remove this'
        }
      ] };
    });
  ...
  describe('cleanItemList', () => {
    ...
    beforeEach(() => {
      ...
      window.fetch = jest.fn().mockImplementation(() => Promise.resolve({
        ok: true, json: () => Promise.resolve(mockUncleanItemList)
      }));
    ...
    it('call the right function depending on the page-- people', async () => {
    ...
    it('call the right function depending on the page-- vehicles', async () => {
    ...
    it('call the right function depending on the page-- planets', async () => {
      const expected = [
        'Name',
        'Terrain',
        'Population',
    ...
    it('return an empty array if it does not recognize the page', async () => {
    //execution
